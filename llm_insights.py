...
"""
        ...
        # Initialize Gemini model (using stable free model)
        model = genai.GenerativeModel('gemini-2.0-flash')
        
        # Configure generation settings for more concise output
        generation_config = {
            'temperature': 0.7,
            'top_p': 0.8,
            'top_k': 40,
...
**Size:** {summary['shape'][0]} rows × {summary['shape'][1]} columns
**Missing Values:** {sum(summary['missing_values'].values())} total
